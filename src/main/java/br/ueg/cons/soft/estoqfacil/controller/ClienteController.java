...
import br.ueg.cons.soft.estoqfacil.mapper.impl.ClienteMapperImpl;
...
public class ClienteController extends CrudController<Cliente, ClienteDTO, Long, ClienteMapperImpl, ClienteServiceImpl> {
