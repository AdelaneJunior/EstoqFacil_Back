...
public class ClienteController extends
    ...
    public ResponseEntity<List<ClienteDTO>> listAllWithSort(@PathVariable String field){
        return ResponseEntity.ok(this.mapper.toDTO(this.service.findClienteWithSortAsc(field)));
    }
    ...
    public ResponseEntity<List<ClienteDTO>> listClientesWithPagination(@PathVariable int offset, @PathVariable int pageSize){
        return ResponseEntity.ok(this.mapper.toDTO(this.service.findClienteWithPagination(offset, pageSize)));
    }
